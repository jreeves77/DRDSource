...
{
  DRD_PERSONALITY_DRD_ROW,            // Personality ID
  "DRD-ROW",                          // Title
  ...
  SIGTYPE_DRD_ROW_CAB,                // Initial Signalling Type
  0,                                  // Initial index into freq table
  SIGTYPE_DRD_ROW_CAB,                // Signalling Type 1
  SIGTYPE_DRD_ROW_AFTC,               // Signalling Type 2
