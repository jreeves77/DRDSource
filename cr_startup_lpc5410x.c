...
WEAK void DMA_IRQHandler1(void);
...
WEAK void CT32B1_IRQHandler1(void);
...
WEAK void UART0_IRQHandler1(void);

WEAK void UART1_IRQHandler1(void);
...
WEAK void  ADC_SEQA_IRQHandler(void) ALIAS(IntDefaultHandler);
...
WEAK void MAILBOX_IRQHandler1(void);
...
// *****************************************************************************
//
// SBL related manisfest constants
//
// *****************************************************************************
...
#define IRQ_PORT_PIN ((0 << 5) + 30)

// misoPortPin
// SPI MISO port (bits 7:5) and pins (bits 4:0)
#define MISO_PORT_PIN ((1 << 5) + 4)

// mosiPortPin
// SPI MOSI port (bits 7:5) and pins (bits 4:0)
#define MOSI_PORT_PIN ((0 << 5) + 12)

// sselPortPin
// SPI SEL port (bits 7:5) and pins (bits 4:0)
#define SSEL_PORT_PIN ((0 << 5) + 14)

// sckPortPin
// SPI SCK port (bits 7:5) and pins (bits 4:0)
#define SCK_PORT_PIN ((1 << 5) + 3)

#define CHECKSUM_VAL (IMG_NO_CRC ^ I2C0_PORT ^ IRQ_PORT_PIN ^ MISO_PORT_PIN ^ MOSI_PORT_PIN ^ SSEL_PORT_PIN ^ \
					  SCK_PORT_PIN)

#define PINCONFIG_WORD0     ((MISO_PORT_PIN << 24) | (IRQ_PORT_PIN << 16) | (I2C0_PORT << 8) | IMG_NO_CRC)
#define PINCONFIG_WORD1     ((CHECKSUM_VAL << 24) | (SCK_PORT_PIN << 16) | (SSEL_PORT_PIN << 8) | MOSI_PORT_PIN)
...
void(*const g_pfnVectors[]) (void) = {
	...
	DMA_IRQHandler1,			// DMA Controller
	...
	CT32B1_IRQHandler1,			// Counter Timer 1
	...
	UART0_IRQHandler1,			// UART0
	UART1_IRQHandler1,			// UART1
...
const unsigned char version_major = CFG_FW_MAJOR_VERSION;
const unsigned char version_minor = CFG_FW_MINOR_VERSION;
