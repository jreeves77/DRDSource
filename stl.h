...
{
  DRD_PERSONALITY_DRD_STL,           // Personality ID
  "DRD-STL",                         // Title
  ...
  SIGTYPE_DRD_STL_CAB,                // Initial Signalling Type
  0,                                  // Initial index into freq table
  SIGTYPE_DRD_STL_CAB,                // Signalling Type 1
  SIGTYPE_DRD_STL_AFTC,               // Signalling Type 2
  SIGTYPE_NONE,                       // Signalling Type 3
  SENSTYPE_SHUNT | SENSDET_SHORT,     // Sensor type for Sig mode 1 (bit encoded as type is bits 7:0 and detection as bits 10:8)
  SENSTYPE_SHUNT | SENSDET_SHORT,     // Sensor type for Sig mode 2 (bit encoded as type is bits 7:0 and detection as bits 10:8)
