...
{
  DRD_PERSONALITY_DRD_CHAR,           // Personality ID
  "DRD-CHAR",                         // Title
  ...
  SIGTYPE_DRD_CHAR_CAB,              // Initial Signalling Type
  0,                                  // Initial index into freq table
  SIGTYPE_DRD_CHAR_CAB,               // Signalling Type 1
  SIGTYPE_DRD_CHAR_AFTC,              // Signalling Type 2
