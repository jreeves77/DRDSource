...
{
  DRD_PERSONALITY_DRD_CATS,           // Personality ID
  "DRD-CATS",                         // Title
  ...
  SIGTYPE_DRD_CATS_CAB,              // Initial Signalling Type
  0,                                  // Initial index into freq table
  SIGTYPE_DRD_CATS_CAB,               // Signalling Type 1
  SIGTYPE_DRD_CATS_AFTC,              // Signalling Type 2
